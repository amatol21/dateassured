...
$otherNews = Article::where('type', ArticleType::POST)
        ...
        <div class="width-limiter">
            ...
            <div class="article-wrap">
                ...
                <div class="other-articles pad p-1">
                    <div class="other-articles_title">Other posts</div>
                    @foreach($otherNews as $news)
                        <a href="{{ route('blog.post', ['slug' => $news->slug], false) }}" class="other-article">
