...
@section('adminContent')
    <div id="articles-list" class="articles-list pad">
        <h2 class="account_title mb-2">
            Blog
            <a href="{{ route('admin.blog.create', [], false) }}" class="btn btn-pink btn-small ml-auto">Create
                post</a>
        </h2>
        <form action="{{ route('admin.blog', [], false) }}" id="articles-filter" class="articles-filter mb-2 pl-2 pr-2">
            ...
            <input type="text" name="title" placeholder="Post title..." value="{{ request()->get('title', '') }}"
            ...
            <table id="articles-table" class="pl-2 pr-2 w-100">
                ...
                @foreach($articles as $article)
                    <tr data-id="{{ $article->id }}">
                        ...
                        <td>
                            <img src="{{ $article->getImageUrl(Size::SMALLEST) }}" alt="Post cover" width="80" height="40">
                        </td>
