...
@section('adminContent')
    <form action="{{ route('admin.news.save', [], false) }}" class="pad" method="POST" id="article-form" enctype="multipart/form-data">
        @csrf

        <h2 class="account_title mb-2">
            <a href="{{ route('admin.news', [], false) }}" class="admin_back-button">News</a>
